function [ y ] = New_trial_exact_Use_H( Pf )
...
W = [0.1667 0.6667 0.1667 ];   % normalize value..
...
y = zeros(1,1);
          ...
          for i = 1:3
            ...
            y1 = (check(u+L, lambda(j))*alpha(i)*W(i)*((-1).^(L+c./2))*((A*alpha(i)).^L)*H_Function_NewTrial([1-L-c./2],[c./2],[], [],[0], [1], [], [], A*alpha(i) ));
            y1
